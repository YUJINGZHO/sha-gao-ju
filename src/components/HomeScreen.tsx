...
const HomeScreen: FC<HomeScreenProps> = ({ bestScore, onStart }) => (
  <main className="sg-screen sg-home-screen" aria-labelledby="sg-home-title">
    ...
    <section className="sg-home-panel">
      ...
      <div className="sg-home-hero-art" aria-hidden="true">
        <span className="sg-hero-plate" />
        <span className="sg-hero-cake sg-hero-cake-left"><i /><b /><u /></span>
        <span className="sg-hero-cake sg-hero-cake-main"><i /><b /><u /><small /></span>
        <span className="sg-hero-cake sg-hero-cake-right"><i /><b /><u /></span>
        <span className="sg-hero-pearl sg-hero-pearl-one" />
        <span className="sg-hero-pearl sg-hero-pearl-two" />
        <span className="sg-hero-bow"><i /><b /></span>
      </div>
    ...
    <aside className="sg-treats-card" aria-label="今日糕单">
      <span className="sg-card-ribbon">今日糕单</span>
